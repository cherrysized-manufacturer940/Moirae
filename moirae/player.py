...
Usage:
    python -m moirae scripts/example.yaml --play
    python -m moirae scripts/example.yaml -o output.mp4
...
import moirae.scenes.conversation  # noqa: F401
import moirae.scenes.action  # noqa: F401
