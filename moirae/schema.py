...
class CameraDirective(BaseModel):
    ...
    y: float = 0.5
    auto_y: bool = False  # If true, compute y from cursor position at marker time
...
class OutputConfig(BaseModel):
    ...
    theme: Optional[str] = None  # None = use skin's terminal_theme
